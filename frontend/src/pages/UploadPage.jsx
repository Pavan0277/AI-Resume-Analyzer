...
const UploadPage = ({ onAnalysisComplete, onViewHistory }) => {
            ...
            <div className="absolute top-6 right-6 z-10 flex items-center gap-3">
                {onViewHistory && (
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shadow-lg"
                    >
                        <svg
                            className="w-5 h-5"
                            fill="none"
